...
import 'package:daar_project/features/vacation_homes/presentation/pages/add_vacation_home_flow.dart';
...
class AppRouter {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RouteNames.partnerMode:
        return MaterialPageRoute(builder: (_) => const AddVacationHomeFlow());
      default:
